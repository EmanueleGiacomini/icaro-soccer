...
void calibraLinee()
{
  ...
  for (int lettura = 0; lettura < 36; lettura++)
  {
    soglia_Linee[lettura] = valMin[lettura];
...
bool lineaRilevata(byte nMux, int lettura)
{
  ...
  if (analogRead(nPin) < soglia_Linee[lettura + (nMux * 12)] && (lettura + (nMux * 12)) != 20 && (lettura + (nMux * 12)) != 22){
