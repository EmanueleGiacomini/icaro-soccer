...
UU:::::U     U:::::UU
 ...
 U:::::::UUU:::::::U p:::::ppppp:::::::p
  UU:::::::::::::UU  p::::::::::::::::p
   ...
   _____ _____  ______ _____  _____ __  __ ______ _   _ _______       _      ______    _____  ________      __  ____  
  / ____|  __ \|  ____|  __ \|_   _|  \/  |  ____| \ | |__   __|/\   | |    |  ____|  |  __ \|  ____\ \    / / |___ \ 
 | (___ | |__) | |__  | |__) | | | | \  / | |__  |  \| |  | |  /  \  | |    | |__     | |__) | |__   \ \  / /    __) |
  \___ \|  ___/|  __| |  _  /  | | | |\/| |  __| | . ` |  | | / /\ \ | |    |  __|    |  _  /|  __|   \ \/ /    |__ < 
  ____) | |    | |____| | \ \ _| |_| |  | | |____| |\  |  | |/ ____ \| |____| |____   | | \ \| |____   \  /     ___) |
...
#define VELOCITA_FUGA_LINEA 190
// Imposta il tempo di fuga dalla linea
#define TEMPO_FUGA 600
...
*/ 
const int linee[] = {2, 3, 31, 26, 27, 14, 15, 16};
...
5:Linea7 Sinistra:Inferiore
6:Linea8 Sinistra:Superiore
7:Linea9 Ant:Sinistra
*/
...
float sin_Linee[8];
float cos_Linee[8];
float rad_Linee[8];// = {1.3963,1.7453,0.610865,2.9671,3.3161,3.14159,4.5379,4.8869,5.67232};
int gradi_Linee[8] = {80,100,35,170,190,260,280,325}; 

// Valori di soglia per ogni sensore
//int soglia_Linee[36];
//
// Sensori individuati limitati a 24 sensori
int sensoriTrovati[8] = {90,90,90,90,90,90,90,90};
...
void setup()
{
  ...
  leggiDipSW();
  if (dipSW4 && dipSW1==0&&dipSW2==0&&dipSW3==0)
  {
    autocalibrazionePalla();
  }

  if (dipSW1 && dipSW2==0&&dipSW3==0&&dipSW4==0)
  {
    bussola_cal();
  }
...
{
  float gradiRad;
  for (int gradi = 0; gradi < 8; gradi++)
  {
    rad_Linee[gradi] = gradi_Linee[gradi]*PI/180;
    sin_Linee[gradi] = sin(rad_Linee[gradi]);
    cos_Linee[gradi] = cos(rad_Linee[gradi]);
    /*
    gradiRad = gradi * 3.14159265 / 180;
    sin_Linee[gradi / 10] = sin(gradiRad);
    cos_Linee[gradi / 10] = cos(gradiRad);
    */
    Serial.print(gradi), Serial.print("\t"), Serial.print(rad_Linee[gradi]), Serial.print("\t"), Serial.print(sin_Linee[gradi]), Serial.print("\t"), Serial.println(cos_Linee[gradi]);
  }
}
