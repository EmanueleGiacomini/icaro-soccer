...
int correzionePrimaria;
unsigned long ultimaLineaPresa = 0;
boolean correzionePrimariaAbilitata = false;
...
void loop()
{
  ...
  individuaLinee();
  //moveRobot(0,0,80,1);
  if ((ultimaLineaPresa + 2000) > millis()) {
    correzionePrimariaAbilitata = false;
  }
