...
int intervallo_Linea = 250, intervallo_correzione = 400; // Timer per lettura della linea
...
void loop()
{
  ...
  */
  if (!digitalRead(26))
  {
    moveRobot(180, 0, 200, 1);
    delay(600);
//    Serial.println("vedo la linea anteriore dx");
  }
  if (!digitalRead(33))
  {
    moveRobot(180, 0, 200, 1);
    delay(600);
//    Serial.println("vedo la linea anteriore sx");
  }
  display.clearScreen();
