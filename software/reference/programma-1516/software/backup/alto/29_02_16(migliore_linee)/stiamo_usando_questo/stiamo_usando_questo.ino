...
// 1) inizializza il programma delle linee, 0) disattiva il programma 
#define rileva_linee 1
...
double kp = 0.80, ki = 0.01, kd = 0.13;
...
const int linee[] = {2, 3, 31, 26, 24, 27, 14, 15, 16, 33};
/*
Index Array:
